...
export class ChartComponent implements OnInit {
  ...
  reqparams = {
    ...
    PatientId: '5836dafef2e48f36ba90a990'
  }
  ...
  DiagnosesByPatientId() {
    ...
    // }
    this.patientService.DiagnosesByPatientId(this.reqparams).subscribe((resp) => {
  ...
  AllergiesByPatientId() {
    ...
    // }
    this.patientService.AllergiesByPatientId(this.reqparams).subscribe((resp) => {
  ...
  PastMedicalHistoriesByPatientId() {
    ...
    //   PatientId: '59dd3796bc6117730c9ca3d3'
    // }
    this.patientService.PastMedicalHistoriesByPatientId(this.reqparams).subscribe((resp) => {
  ...
  ImmunizationsByPatientId() {
    ...
    // }
    this.patientService.ImmunizationsByPatientId(this.reqparams).subscribe((resp) => {
  ...
  MedicationsByPatientId() {
    ...
    // }
    this.patientService.MedicationsByPatientId(this.reqparams).subscribe((resp) => {
  ...
  EncountersByPatientId() {
    ...
    // }
    this.patientService.EncountersByPatientId(this.reqparams).subscribe((resp) => {
  ...
  AppointmentsByPatientId() {
    ...
    // }
    this.patientService.AppointmentsByPatientId(this.reqparams).subscribe((resp) => {
